...
public class IndexModel : PageModel
{
  ...
  {
    var slmModel = _config["SLM:Model"]!;
    var slmEndpoint = _config["SLM:BaseUrl"]!;
    var slmApiKey = _config["SLM:ApiKey"]!;

    var builder = Kernel.CreateBuilder();

    var client = new OpenAIClient(new ApiKeyCredential(slmApiKey), new OpenAIClientOptions { Endpoint = new Uri(slmEndpoint) });
    builder.AddOpenAIChatCompletion(slmModel, client);
